...
public class ExtendExecutorMybatisAutoConfiguration extends BaseMybatisConfiguration {

    public ExtendExecutorMybatisAutoConfiguration(DatabaseProperties databaseProperties) {
