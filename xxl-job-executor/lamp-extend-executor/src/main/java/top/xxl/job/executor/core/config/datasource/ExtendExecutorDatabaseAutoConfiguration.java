...
public class ExtendExecutorDatabaseAutoConfiguration extends BaseMasterDatabaseConfiguration {

    public ExtendExecutorDatabaseAutoConfiguration(MybatisPlusProperties properties,
